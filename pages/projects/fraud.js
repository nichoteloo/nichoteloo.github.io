...
import fraud from '../../public/images/fraud.png';

const Fraud = () => {
    return (
        <Main title="LLM Fraud Analyst">
            <Container px={{ base: 4, sm: 6 }} pt={20} maxW="container.md">
                ...
                <Box mt={8} fontSize={{ base: "13px", md: "14px" }}>
                    ...
                    <SlideIn delay={0.9} time={1} direction="right">
                        <Flex align="flex-start" wrap="wrap" gap={2} mt={2}>
                            ...
                            <Text color="gray.300" flex="1">
                                Python, Airflow, Streamlist, Ollama, Qwen, LLM
                            </Text>
                        </Flex>
                    </SlideIn>
                    ...
                    <SlideIn delay={1.0} time={1} direction="left">
                        <Flex align="center" wrap="wrap" gap={2} mt={2}>
                            ...
                            <NextLink href="https://github.com/nichoteloo/fraud-transaction-etl" passHref>
                                <Link
                                    isExternal
                                    color="blue.400"
                                    fontWeight="500"
                ...
                <Grow delay={1.3} time={1}>
                    <Box display="flex" justifyContent="center" mt={8}>
                        <Image
                            src={fraud}
                            alt="LLM Fraud Analyst - Arch Diagram"
                            borderRadius="lg"
                            shadow="lg"
                            maxW="100%"
                            h="auto"
